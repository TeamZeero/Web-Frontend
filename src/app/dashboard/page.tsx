...
export default function DashboardPage() {
        ...
        if (key?.startsWith("survey_")) {
          try {
            ...
            savedSurveys.push({
              ...
              responses: surveyData.responses || 0, // Use actual response count
              completionRate: surveyData.completionRate || 0, // Use actual completion rate
              createdAt: surveyData.createdAt || "2025-09-05",
              lastModified: surveyData.lastModified || "2025-09-05",
  ...
  const handleDeleteSurvey = (surveyId: string) => {
    ...
    // Clear current survey if it's the one being deleted
  ...
  const handleStatusChange = (surveyId: string, status: "active" | "draft" | "closed") => {
    setSurveys(
      surveys.map((survey) => (survey.id === surveyId ? { ...survey, status, lastModified: "2025-09-05" } : survey)),
    )
  }
